                ...
                <div class="col-xl-4 col-lg-4 col-sm-8 order-lg-1 order-1">
                    <div class="footer-widget">
                        ...
                        <form class="subscribe-form mt-4">
                            @csrf
                            <input type="email" name="email" id="emailSub" required class="form--control" placeholder="@lang('Enter email address')">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>@lang('Copyright') © {{Carbon\Carbon::now()->format('Y')}} <a href="{{ route('home') }}" class="text--base"> {{__(gs('site_name'))}} </a> @lang('All Right Reserved')</p>
                </div>
            </div>
        </div>
    </div>
